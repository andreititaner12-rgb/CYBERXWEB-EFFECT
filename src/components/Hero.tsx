...
export const Hero: React.FC<HeroProps> = ({ 
  ...
  const contentTranslateY = useTransform(scrollY, [0, 480], [0, -60]);
  const contentScale = useTransform(scrollY, [0, 480], [1, 0.97]);
  ...
  return (
    <section 
      id="hero" 
      ref={sectionRef}
      className="sticky top-0 h-screen min-h-[620px] w-full overflow-hidden select-none bg-[#020204] z-10 flex flex-col justify-between"
    >
      ...
      <motion.div 
        ...
        className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-8 sm:pb-12 flex-1 flex flex-col justify-center"
      >
        ...
        <motion.div
          ...
          className="flex items-center gap-2.5 mb-3 sm:mb-4 lg:mb-5"
        >
          <span className="w-5 sm:w-8 h-[2px] bg-[#E32124] shadow-[0_0_8px_#E32124]" />
        ...
        {/* 2. Main Title: Large, High-Impact Modern Typography */}
        <motion.div
        ...
        >
          ...
          <h1 className="font-display font-black text-5xl sm:text-7xl md:text-8xl lg:text-[112px] xl:text-[136px] 2xl:text-[154px] tracking-tight text-white uppercase leading-[0.84] drop-shadow-[0_10px_35px_rgba(0,0,0,0.85)]">
            CYBERX
          </h1>

          {/* АРЕНЫ (Outlined text) */}
          <div className="font-display font-black text-5xl sm:text-7xl md:text-8xl lg:text-[112px] xl:text-[136px] 2xl:text-[154px] tracking-tight uppercase leading-[0.84] text-outline-hero drop-shadow-[0_10px_30px_rgba(0,0,0,0.85)]">
            АРЕНЫ
          </div>
        ...
        <motion.p
          ...
          className="mt-4 sm:mt-6 lg:mt-7 text-xs sm:text-sm md:text-base lg:text-lg text-zinc-300 max-w-[340px] sm:max-w-xl lg:max-w-2xl font-normal leading-relaxed drop-shadow-md"
        >
        ...
        <motion.div
          ...
          className="mt-6 sm:mt-8 lg:mt-9 flex flex-row items-center gap-3 sm:gap-5 flex-wrap"
        >
          ...
          <button
            ...
            className="group relative px-6 sm:px-9 py-3.5 sm:py-4 rounded-full bg-gradient-to-r from-[#E32124] via-[#FF2A2E] to-[#E32124] text-white font-mono text-[11px] sm:text-xs md:text-sm font-black uppercase tracking-wider sm:tracking-[0.2em] shadow-[0_0_30px_rgba(227,33,36,0.65)] hover:shadow-[0_0_50px_rgba(227,33,36,0.95)] hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2 cursor-pointer border border-white/20 overflow-hidden whitespace-nowrap"
          >
